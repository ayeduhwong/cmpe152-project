...
public:
  ...
  enum {
    RuleProgram = 0, RuleHeader = 1, RuleMainBlock = 2, RuleDeclarations = 3, 
    RuleDeclList = 4, RuleDecl = 5, RuleVarList = 6, RuleVarId = 7, RuleTypeId = 8, 
    RuleCompoundStmt = 9, RuleStmt = 10, RuleStmtList = 11, RuleAssignmentStmt = 12, 
    RuleVariable = 13, RuleExpr = 14, RuleNumber = 15, RuleTrue_false = 16, 
    RuleMulDivOp = 17, RuleAddSubOp = 18, RuleRel_op = 19, RuleIf_statement = 20, 
    RuleWhile_loop = 21
  };
  ...
  public:
    ...
    antlr4::tree::TerminalNode *PICKUP();
  ...
  public:
    ...
    True_falseContext() = default;
    void copyFrom(True_falseContext *context);
    using antlr4::ParserRuleContext::copyFrom;
  ...
  class  BoolConstContext : public True_falseContext {
  public:
    BoolConstContext(True_falseContext *ctx);
